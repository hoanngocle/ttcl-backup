  ...
  <b-card-code title="Extended">
    ...
    <validation-observer ref="simpleRules">
      <b-form>
        <b-row>
          <b-col md="6">
            <b-form-group label="Credit Card">
              <validation-provider #default="{ errors }" name="Credit Card" rules="required|credit-card">
                <b-form-input
                  v-model="cardNUm"
          ...
          <b-col md="6">
            <b-form-group label="Enter Only Positive Number">
              <validation-provider #default="{ errors }" name="Number" rules="required|positive">
                <b-form-input
                  v-model="posNum"
                  :state="errors.length > 0 ? false : null"
        ...
        <!-- submit button -->
        <b-form-group>
          <b-button type="submit" variant="primary" @click.prevent="validationForm"> Submit </b-button>
        </b-form-group>
      </b-form>
    </validation-observer>
