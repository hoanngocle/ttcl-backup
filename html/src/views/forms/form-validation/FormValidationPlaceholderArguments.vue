<template>
  <b-card-code title="Arguments Placeholders">
    <b-card-text
      >vee-validate interpolation can parse placeholders that match the rule parameters, so to define such a message for
      the min rule you can use a {length} placeholder in the error message like this:</b-card-text
    >
    ...
    <validation-observer ref="simpleRules">
      <b-form>
        <b-row>
          ...
          <!-- reset button -->
          <b-col cols="12">
            <b-button variant="primary" type="submit" @click.prevent="validationForm"> Reset </b-button>
          </b-col>
        </b-row>
      </b-form>
    </validation-observer>
