        ...
        <validation-observer #default="{ handleSubmit }" ref="refFormObserver">
          ...
          <b-form class="p-2" @submit.prevent="handleSubmit(onSubmit)" @reset.prevent="resetForm">
            ...
            <validation-provider #default="validationContext" name="Calendar" rules="required">
              <b-form-group label="Calendar" label-for="calendar" :state="getValidationState(validationContext)">
                <v-select
            ...
            <!-- All Day -->
            <b-form-group>
              <b-form-checkbox v-model="eventLocal.allDay" name="check-button" switch inline> All Day </b-form-checkbox>
            </b-form-group>
