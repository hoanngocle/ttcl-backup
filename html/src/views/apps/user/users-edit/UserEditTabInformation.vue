      ...
      <b-row>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Gender" label-for="gender" label-class="mb-1">
            <b-form-radio-group id="gender" v-model="userDataInfo.gender" :options="genderOptions" value="male" />
          </b-form-group>
        </b-col>
      ...
      <b-row class="mt-1">
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Address Line 2" label-for="address-line-2">
            <b-form-input id="address-line-2" v-model="userDataInfo.addressLine2" placeholder="Los Santos" />
          </b-form-group>
        </b-col>
        ...
        <b-col cols="12" md="6" lg="4">
          <b-form-group label="Postcode" label-for="postcode">
            <b-form-input id="postcode" v-model="userDataInfo.postcode" type="number" placeholder="597626" />
          </b-form-group>
        </b-col>
