        ...
        <b-row>
          ...
          <b-col md="4">
            <b-card class="popular" align="center">
              ...
              <!-- img -->
              <b-img v-if="pricing.standardPlan.img" :src="pricing.standardPlan.img" class="mb-1" alt="svg img" />
              <!--/ img -->
              ...
              <!-- plan benefit -->
              <b-list-group class="list-group-circle text-left">
                <b-list-group-item v-for="(data, index) in pricing.standardPlan.planBenefits" :key="index">
                  {{ data }}
                </b-list-group-item>
              </b-list-group>
              <!--/ plan benefit -->
        ...
        <b-col lg="10" offset-lg="3" class="mx-auto">
          <div class="pricing-trial-content d-flex justify-content-between">
            <div class="text-center text-md-left mt-3">
              ...
              <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mt-2 mt-lg-3">
