      ...
      <b-row>
        ...
        <b-col md="6">
          <b-form-group label-for="account-linkedin" label="LinkedIn">
            <b-form-input id="account-linkedin" v-model="localOptions.socialLinks.linkedIn" placeholder="Add link" />
          </b-form-group>
        </b-col>
        <!-- linkedin -->
        ...
        <b-col md="6">
          <b-form-group label="Instagram" label-for="account-instagram">
            <b-form-input id="account-instagram" v-model="localOptions.socialLinks.instagram" placeholder="Add link" />
          </b-form-group>
        </b-col>
        <!--/ instagram -->
...
<script>
import { BButton, BForm, BFormGroup, BFormInput, BRow, BCol, BCard, BCardText, BLink, BAvatar } from 'bootstrap-vue';
