        ...
        <b-card tag="article" no-body>
          ...
          <b-card-body>
            ...
            <div class="d-flex justify-content-between align-items-center">
              ...
              <b-link :to="{ name: 'pages-blog-detail', params: { id: blog.id } }" class="font-weight-bold">
                Read More
              </b-link>
            </div>
          </b-card-body>
        ...
        >
          ...
          <b-media-body>
            <h6 class="blog-recent-post-title">
              <b-link :to="{ name: 'pages-blog-detail', params: { id: recentpost.id } }" class="text-body-heading">
                {{ recentpost.title }}
              </b-link>
            </h6>
