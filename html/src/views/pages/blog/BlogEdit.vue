    ...
    <b-form class="mt-2">
      <b-row>
            ...
            <b-media no-body vertical-align="center" class="flex-column flex-md-row">
              ...
              <b-media-body>
                ...
                <b-card-text class="my-50">
                  <b-link id="blog-image-text"> C:\fakepath\{{ blogFile ? blogFile.name : 'banner.jpg' }} </b-link>
                </b-card-text>
        ...
        <b-col cols="12" class="mt-50">
          <b-button v-ripple.400="'rgba(255, 255, 255, 0.15)'" variant="primary" class="mr-1"> Save Changes </b-button>
          <b-button v-ripple.400="'rgba(186, 191, 199, 0.15)'" variant="outline-secondary"> Cancel </b-button>
        </b-col>
      </b-row>
    </b-form>
    <!--/ form -->
