  ...
  <div>
    ...
    <b-row class="match-height">
      <b-col xl="2" md="4" sm="6">
        <statistic-card-vertical icon="EyeIcon" statistic="36.9k" statistic-title="Views" color="info" />
      </b-col>
      <b-col xl="2" md="4" sm="6">
        <statistic-card-vertical color="warning" icon="MessageSquareIcon" statistic="12k" statistic-title="Comments" />
      </b-col>
      <b-col xl="2" md="4" sm="6">
        <statistic-card-vertical color="danger" icon="ShoppingBagIcon" statistic="97.8k" statistic-title="Orders" />
      </b-col>
      <b-col xl="2" md="4" sm="6">
        <statistic-card-vertical color="primary" icon="HeartIcon" statistic="26.8" statistic-title="Favorited" />
      </b-col>
      <b-col xl="2" md="4" sm="6">
        <statistic-card-vertical color="success" icon="AwardIcon" statistic="689" statistic-title="Reviews" />
      </b-col>
      <b-col xl="2" md="4" sm="6">
    ...
    <b-row>
      ...
      <b-col lg="3" sm="6">
        <statistic-card-horizontal icon="ServerIcon" color="success" statistic="1.2gb" statistic-title="Memory Usage" />
      </b-col>
      <b-col lg="3" sm="6">
