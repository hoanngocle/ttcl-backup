  ...
  <b-row>
    <b-col cols="12">
      ...
      <b-card title="Default Colors" class="background-color">
        ...
        <b-card-text class="mb-0"> We have a series of colors that are used by default. They include: </b-card-text>
      ...
      <b-card title="Gradient Colors">
        <b-card-text class="mb-0"> We have make gradient color based on our default color: </b-card-text>
        <ul class="colors-list list-unstyled mb-0">
          <li>
            <feather-icon size="15" icon="ChevronsRightIcon" />
