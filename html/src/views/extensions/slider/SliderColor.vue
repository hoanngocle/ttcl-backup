<template>
  <b-card-code title="Slider Colors - Handles">
    ...
    <vue-slider v-model="value1" :tooltip="'none'" class="mb-2 vue-slider-secondary" :direction="direction" />

    <!-- success -->
    <h6>Success Color Slider</h6>
    <vue-slider v-model="value2" :tooltip="'none'" class="mb-2 vue-slider-success" :direction="direction" />
    ...
    <vue-slider v-model="value3" :tooltip="'none'" class="mb-2 vue-slider-warning" :direction="direction" />
