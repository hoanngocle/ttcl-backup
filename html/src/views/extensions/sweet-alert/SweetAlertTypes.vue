<template>
  <b-card-code title="Types">
    ...
    <div class="demo-inline-spacing">
      <b-button v-ripple.400="'rgba(40, 199, 111, 0.15)'" variant="outline-success" @click="success">
        Success
      </b-button>
      <b-button v-ripple.400="'rgba(234, 84, 85, 0.15)'" variant="outline-danger" @click="error"> Error </b-button>
      <b-button v-ripple.400="'rgba(255, 159, 67, 0.15)'" variant="outline-warning" @click="warning">
        Warning
      </b-button>
      <b-button v-ripple.400="'rgba(0, 207, 232, 0.15)'" variant="outline-info" @click="info"> Info </b-button>
    </div>
