  ...
  <b-card v-if="data">
    <b-row class="pb-50">
      ...
      <b-col sm="6" cols="12" order-sm="2" order="1" class="d-flex justify-content-between flex-column text-right">
        <div>
          <b-dropdown text="Last 7 Days" variant="transparent" class="chart-dropdown" left no-caret size="sm">
...
<script>
import { BCard, BRow, BCol, BButton, BDropdown, BDropdownItem, BProgress, BCardText } from 'bootstrap-vue';
