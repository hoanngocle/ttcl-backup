      ...
      <b-col cols="12">
        ...
        <div class="demo-inline-spacing">
          <div class="d-flex align-items-center">
            <b-form-checkbox v-model="showDecadeNav" switch inline> Show decade navigation buttons </b-form-checkbox>
          </div>

          <div class="d-flex align-items-center">
            <b-form-checkbox v-model="hideHeader" switch inline> Hide the date header </b-form-checkbox>
          </div>
        </div>
      </b-col>
