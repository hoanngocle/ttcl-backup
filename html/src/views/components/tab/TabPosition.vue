        ...
        <b-tabs content-class="mt-2">
          ...
          <b-tab title="Tab 2">
            <b-card-text>
              ...
              liquorice. Oat cake lemon drops gingerbread dessert caramels. Sweet dessert jujubes powder sweet sesame
              snaps. Sweet fruitcake cheesecake biscuit cotton candy. Cookie powder marshmallow donut.
            </b-card-text>
          </b-tab>
        </b-tabs>
      </b-tab>
      ...
      <b-tab title="Right">
        <b-tabs vertical end nav-class="nav-right" nav-wrapper-class="nav-vertical">
          <b-tab active title="Tab 1">
            ...
            <b-card-text>
              Sweet chocolate muffin fruitcake gummies jujubes pie lollipop. Brownie marshmallow caramels gingerbread
              jelly beans chocolate bar oat cake wafer.
            </b-card-text>
          </b-tab>
          <b-tab title="Tab 2">
            <b-card-text>
              Sugar plum tootsie roll biscuit caramels. Sweet fruitcake cheesecake biscuit cotton candy. Cookie powder
              marshmallow donut. Liquorice brownie pastry cotton candy oat cake fruitcake jelly chupa chups. Pudding
              caramels pastry powder cake soufflé wafer caramels. Jelly-o pie cupcake.
            </b-card-text>
            <b-card-text>
              Sweet chocolate muffin fruitcake gummies jujubes pie lollipop. Brownie marshmallow caramels gingerbread
          ...
          <b-tab title="Tab 3">
            <b-card-text>
              ...
              candy canes bear claw ice cream cake chocolate bar donut. Toffee cotton candy liquorice. Oat cake lemon
              drops gingerbread dessert caramels. Sweet dessert jujubes powder sweet sesame snaps.
            </b-card-text>
            <b-card-text>
              Candy cookie sweet roll bear claw sweet roll. Cake tiramisu cotton candy gingerbread cheesecake toffee
              cake. Cookie liquorice dessert candy canes jelly.
            </b-card-text>
          </b-tab>
        </b-tabs>
      </b-tab>
      ...
      <b-tab title="Bottom">
        <b-tabs end>
          ...
          <b-tab title="Tab 2">
            ...
            <b-card-text>
              Sesame snaps lemon drops candy marzipan donut brownie tootsie roll. Icing croissant bonbon biscuit gummi
              bears.
            </b-card-text>
          </b-tab>
          <b-tab title="Tab 3">
