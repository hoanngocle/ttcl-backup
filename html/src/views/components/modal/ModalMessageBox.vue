<template>
  <b-card-code title="Confirm message box">
    ...
    <div class="demo-inline-spacing">
      <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" @click="showMsgBoxOne">
        Simple msgBoxConfirm
      </b-button>
      <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" variant="outline-primary" @click="showMsgBoxTwo">
