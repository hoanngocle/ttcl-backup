<template>
  <b-card-code title="Modal Sizes">
    <b-card-text class="mb-0">
      ...
      <code>size</code>
      <span>
        . These sizes kick in at certain breakpoints to avoid horizontal scrollbars on narrower viewports. Valid
        optional sizes are
      </span>
    ...
    >
      <b-card-text
        ...
        powder cupcake ice cream tootsie roll jelly.</b-card-text
      >
    </b-modal>
