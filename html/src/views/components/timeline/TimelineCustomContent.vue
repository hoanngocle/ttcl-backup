  ...
  <b-card-code title="Custom Content">
    <app-timeline>
      ...
      <app-timeline-item variant="success">
        ...
        <b-button v-b-toggle.report-list v-ripple.400="'rgba(113, 102, 240, 0.15)'" size="sm" variant="outline-primary">
          Show Report
        </b-button>
        <b-collapse id="report-list">
          <b-list-group flush class="mt-1">
            <b-list-group-item href="#" class="d-flex justify-content-between align-items-center bg-transparent">
      ...
      <app-timeline-item variant="danger">
        ...
        <p>
          Develop an online store of electronic devices for the provided layout, as well as develop a mobile version of
          it. The must be compatible with any CMS.
        </p>
        <div class="d-flex flex-sm-row flex-column justify-content-between align-items-start">
          <!-- 1st Col -->
