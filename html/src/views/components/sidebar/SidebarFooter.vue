<template>
  <b-card-code title="Footer">
    ...
    <div>
      <b-button v-ripple.400="'rgba(113, 102, 240, 0.15)'" v-b-toggle.sidebar-footer variant="outline-primary">
        Toggle Sidebar
      </b-button>
      <b-sidebar id="sidebar-footer" aria-label="Sidebar with custom footer" shadow backdrop bg-variant="white">
        <sidebar-content />
        <template #footer>
